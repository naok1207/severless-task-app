// https://flowbite.com/docs/plugins/datepicker/#autohide
// https://flowbite.com/docs/plugins/datepicker/#javascript\
// https://flowbite.com/docs/getting-started/react/
// https://github.com/themesberg/flowbite-react/blob/bfef57a8edc6d338ba6971f07d3a8cd5856b9fa6/README.md

import React from 'react'

const DatePickerInput = () => {
  /**
   * flowbite-reactのDatePickerがまだリリースされていないため一時的に簡易的なものを利用
   */
  // return (
